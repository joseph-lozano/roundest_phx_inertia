  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="preload"
          href={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${nextFirst.pokemonId}.png`}
          as="image"
        />
        <link
          rel="preload"
          href={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${nextSecond.pokemonId}.png`}
          as="image"
        />
      </Head>
